    ...
    it('can catch Error in promise chain', function(done) {
        ...
        Promise.join(
            ...
            return result[0].update({
                username: result[1]._meta.username
            });
        }).then(function(user) {
